...
This framework includes experimental validation of its core prediction. See [EMPIRICAL_VALIDATION.md](EMPIRICAL_VALIDATION.md) for details.

**Key result**: Closed-loop text generation exhibits 28% entropy collapse and 30% vocabulary reduction over 30 iterations, while exogenous injection maintains stability (p < 0.01, visual inspection).
